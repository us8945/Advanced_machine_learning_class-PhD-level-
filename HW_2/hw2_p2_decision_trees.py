...
@author: uri
Implement decision trees to classify poison mushrooms. Data set from:
...
class decision_tree(object):
    ...
    def print_tree(self,node=None,print_ident=''):
        if node is None:
        ...
        if node.classification is not None:
            ...
            print(print_ident+"True--->")
            self.print_tree(node.true_node, print_ident)
            print(print_ident+"False--->")
            self.print_tree(node.false_node, print_ident)
